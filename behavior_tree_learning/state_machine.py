...
class SMParameters:
    ...
    drop_probability: float = 0.2                        # Probability of dropping the cube during motion (Pose transition)
    lost_probability: float = 0.4                         # Probability of loosing the localization during motion (Pose transition)
    verbose: bool = False                                 # Extra prints

class StateMachine:
    """
    Class for handling the State Machine Simulators
    """
